...
$cpuser = "sspfibe1"; // Username used to login to CPanel
$cppass = "8Cs48pi0uB"; // Password used to login to CPanel
$domain = "https://dci17.dewaweb.com:2083"; // Domain name where CPanel is run
$skin = "paper_lantern"; // Set to cPanel skin you use (script won't work if it doesn't match)

// Info required for FTP host
$ftpuser = "phoenix@ssp-fiberglass.com"; // Username for FTP account
$ftppass = "Phoenix1212"; // Password for FTP account
