            ...
            setTimeout(function () {
                $(document).imagesLoaded(function () {
                    if (
                        ...
                        matchMedia("only screen and (max-width: 1199px)")
                            .matches
                    ) {
                        $(".equalize").equalize({
                            equalize: "outerHeight",
            ...
            $(".themesflat-content-box").each(function () {
                ...
                if (padding) {
                    if (mode === "desktop") {
                        ...
                        $(this).attr(
                            "style",
                            "padding:" + $(this).data("sdesktoppadding")
                        );
                        ...
                        $(this).attr(
                            "style",
                            "padding:" + $(this).data("smobipadding")
                        );
                    }
                }
