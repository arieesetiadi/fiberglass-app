                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-light d-flex justify-content-between" role="tablist">
                            ...
                            <a class="nav-link border" href="{{ route('jobs.create') }}">
                                <div class="d-flex align-items-center">
                                        ...
                                        <tbody>
                                            @forelse ($jobs as $job)
                                                <tr>
                                                    ...
                                                    <td>{{ $job->title }}</td>
                                                    <td>
                                                        <form action="{{ route('jobs.edit', $job->id) }}"
                                                        ...
                                                        <form action="{{ route('jobs.destroy', $job->id) }}"
                                                            ...
                                                            <button onclick="return confirm('Job ini akan dihapus')"
